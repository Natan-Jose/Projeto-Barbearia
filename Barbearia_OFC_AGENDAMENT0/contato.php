...
<body>
    <center>
        ...
        <center>
            ...
            <a href="https://instagram.com/barbeiroshop100?igshid=MzNlNGNkZWQ4Mg==" target="_blank"> @BARBERSHOP </a>
            <h3>Contato</h3>
          

            <!--<h3 id="perfil">Siga nosso Instagram <img src="imagens/favicon-32x32.png" alt="Logo Instagram"></h3>  <h3 id="perfil">@BARBERSHOP</h3><!-->
            <hr>
        </center>
                ...
                <div id="whatswidget-widget-wrapper" class="whatswidget-widget-wrapper" style="all:revert;">
                    <div id="whatswidget-conversation" class="whatswidget-conversation"
                        ...
                        <div id="whatswidget-conversation-message" class="whatswidget-conversation-message"
                            style="all:revert;">OFERECEMOS UM ATENDIMENTO COMPLETO E PERSONALIZADO!</div>
                        <div class="whatswidget-conversation-cta" style="all:revert;"> <a style="all:revert;"
                                id="whatswidget-phone-desktop" target="_blank"
                                href="https://web.whatsapp.com/send?phone=5581987443772"
                                class="whatswidget-cta whatswidget-cta-desktop">Enviar Mensagem</a> <a
                                id="whatswidget-phone-mobile" target="_blank" href="https://wa.me/5581987443772"
                                class="whatswidget-cta whatswidget-cta-mobile" style="all:revert;">Enviar Mensagem</a>
                        </div><a target="_blank" class="whatswidget-link"
                            href="https://www.adamante.com.br/code/whatsapp-site/" title="Feito no WhatsWidget"
                            style="all:revert;"><img
                    ...
                    <div id="whatswidget-conversation-message-outer" class="whatswidget-conversation-message-outer"
                        style="all:revert;"> <span id="whatswidget-text-header-outer"
                            class="whatswidget-text-header-outer" style="all:revert;">BARBERSHOP</span><br>
                        <div id="whatswidget-text-message-outer" class="whatswidget-text-message-outer"
                            style="all:revert;">OFERECEMOS UM ATENDIMENTO<br> COMPLETO E PERSONALIZADO!</div>
                    </div>
