...
if (isset($_POST['enviar'])) {
    ...
    if (!$error) {
        ...
        if ($stmt->fetchColumn() > 0) {
            $error_message = '<div class="error">Este endereço de e-mail já está em uso.</div>';
...
<body>
    ...
    <form method="POST" action="registration.php">
        ...
        <fieldset>
            ...
            <input type="text" name="name" id="name" placeholder="Digite o nome completo" required value="<?php if ($error)
                echo $name; ?>" />
    ...
    Já registrado? <a href="login.php" target="_blank">Entre aqui</a>
